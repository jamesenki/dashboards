...
async def load_aquatherm_test_data():
    ...
    async for session in session_generator:
        ...
        try:
            ...
            # First, delete all existing water heaters to ensure a clean slate
            try:
                logger.info("Removing any existing water heaters...")
                existing_devices = await repo.get_devices_by_type("water_heater")
