...
def create_clean_database(db_path, backup_existing=True):
    ...
    try:
        ...
        cursor.executemany(
            "INSERT INTO models (id, name, description) VALUES (?, ?, ?)", models
        )
        ...
        rules = [
            ...
            (
                ...
                "<",
                "WARNING",
                "Alert when recall falls below threshold",
                1,
            ),
            (
                "rule4",
                ...
                "<",
                "INFO",
                "Alert when F1 score falls below threshold",
                0,
            ),
            (
                "rule5",
        ...
        cursor.executemany(
            "INSERT INTO model_tags (id, name, color) VALUES (?, ?, ?)", tags
        )
        ...
        conn.commit()
        logger.info(
            f"Created clean database at {db_path} with all required tables and sample data"
        )
        return True
