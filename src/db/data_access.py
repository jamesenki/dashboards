...
class DataAccess:
    ...
    def update(self, table: str, data: Dict[str, Any], condition: str, params: List) -> int:
        """
        ...
        if self.sql_validator.is_unsafe(table) or self.sql_validator.is_unsafe(condition):
            raise ValueError("Potentially unsafe SQL detected")
