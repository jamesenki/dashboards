...
def run_mlops_pipeline_example():
    ...
    feature_store.register_feature_transformer(
        ...
        lambda df: df["temperature"] / df["pressure"]
    )
    ...
    batch_data = [
        {"device_id": "WH-1001", "temperature": 65.5, "pressure": 32.1, "age_days": 720},
        {"device_id": "WH-1002", "temperature": 78.3, "pressure": 34.5, "age_days": 980},
        {"device_id": "WH-1003", "temperature": 68.2, "pressure": 33.0, "age_days": 540}
    ]
    ...
    feedback_service.record_feedback(
        ...
        details={"user_notes": "Device is working correctly", "actual_status": "operational"}
    )
