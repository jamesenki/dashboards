...
class FeatureStore:
    ...
    def register_feature(self, device_id: str, feature_name: str, 
                        feature_value: float, timestamp: datetime) -> bool:
        """
        ...
        try:
            ...
            logger.debug(f"Registered feature {feature_name}={feature_value} for device {device_id}")
            return True
    ...
    def get_feature_values(self, device_id: str, feature_names: List[str] = None,
    ...
    def get_training_dataset(self, feature_names: List[str] = None,
    ...
    def register_feature_transformer(self, feature_name: str, 
                                   transformer_type: str,
                                   transformer_path: str) -> bool:
        """
        ...
        try:
            ...
            logger.info(f"Registered {transformer_type} transformer for feature {feature_name}")
            return True
