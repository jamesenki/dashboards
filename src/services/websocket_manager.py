...
class WebSocketManager:
    ...
    async def connect(self, websocket: WebSocket, device_id: str, connection_type: str = "state", client_id: str = None):
        """
    ...
    async def disconnect(self, websocket: WebSocket, device_id: str = None, connection_type: str = None, client_id: str = None):
        """
        ...
        if device_id:
            ...
            if connection_type and device_id in self.active_connections:
                if connection_type in self.active_connections[device_id]:
                    self.active_connections[device_id][connection_type].discard(websocket)
                    # Clean up empty sets
    ...
    async def broadcast_to_device(self, device_id: str, message: Any, connection_type: str = None):
        """
