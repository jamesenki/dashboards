...
class WaterHeaterService:
    ...
    def __init__(self, repository: Optional[WaterHeaterRepository] = None):
        ...
        if repository:
            ...
            use_mock_data = os.environ.get("USE_MOCK_DATA", "True").lower() in [
                "true",
                "1",
                "yes",
            ]
    ...
    async def get_water_heater(self, device_id: str) -> Optional[WaterHeater]:
        ...
        try:
            ...
            logger.warning(
                f"Water heater {device_id} not found in repository, falling back to dummy data"
            )
    ...
    async def update_target_temperature(
        ...
        try:
            ...
            if water_heater.current_temperature < temperature - 1.0:
                ...
                getattr(water_heater, "status", "") == WaterHeaterStatus.HEATING.value
            ...
            updates = {"target_temperature": temperature, "last_seen": datetime.now()}
    ...
    async def update_mode(
        ...
        try:
            ...
            if mode == WaterHeaterMode.ECO and water_heater.target_temperature > 55.0:
                ...
                mode == WaterHeaterMode.BOOST and water_heater.target_temperature < 65.0
            ):
            ...
            updates = {"mode": mode, "last_seen": datetime.now()}
    ...
    async def add_temperature_reading(
        ...
        try:
            ...
            target_temp = (
                ...
                if hasattr(water_heater, "target_temperature")
                else 50.0
            )
            new_status = (
                WaterHeaterStatus.HEATING
                if temperature < target_temp - 1.0
            ...
            if temperature < water_heater.target_temperature - 1.0:
                ...
                water_heater.heater_status == WaterHeaterStatus.HEATING
                and temperature >= water_heater.target_temperature
            ):
                updates["heater_status"] = WaterHeaterStatus.STANDBY
