...
async def get_device_shadow(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail=f"Error getting shadow document: {str(e)}"
        )

@router.put("/{device_id}/shadow")
async def update_device_shadow(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail=f"Error updating shadow document: {str(e)}"
        )
...
async def get_device_telemetry(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail=f"Error getting telemetry data: {str(e)}"
        )
