...
async def get_water_heater(device_id: str = Path(..., description="The ID of the water heater")):
...
async def update_temperature(
    ...
    temperature: float = Body(..., embed=True, description="The new target temperature")
):
...
async def update_mode(
    device_id: str = Path(..., description="The ID of the water heater"),
    mode: WaterHeaterMode = Body(..., embed=True, description="The new operational mode")
):
...
async def add_reading(
    ...
    energy_usage: Optional[float] = Body(None, description="The current energy usage (watts)"),
    flow_rate: Optional[float] = Body(None, description="The current flow rate (L/min)")
):
