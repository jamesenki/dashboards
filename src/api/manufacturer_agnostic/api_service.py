...
class DeviceAPI:
        ...
        try:
            ...
            result = {
                ...
                "metadata": {
                    ...
                    "warranty_expiration": device["warranty_expiration"].isoformat() if device["warranty_expiration"] else None,
            ...
            if recent_telemetry:
                result["latest_telemetry"] = {
                    ...
                    "power_consumption_watts": recent_telemetry["power_consumption_watts"],
    ...
    def get_operational_summary(self, device_ids=None, include_maintenance=True):
        ...
        try:
                    ...
                    if device_id in maintenance_by_device:
                        ...
                        if maint["issues"]:
                            try:
                                ...
                                logger.error(f"Error parsing maintenance issues for {device_id}")
                        
                        device_summary["maintenance"] = {
                            "health_score": maint["health_score"],
                            "estimated_remaining_life": maint["estimated_remaining_life"],
                            "maintenance_due": maint["maintenance_due"],
                            "next_maintenance_date": maint["next_maintenance_date"].isoformat() if maint["next_maintenance_date"] else None,
                            "issues": issues
                        }
                    else:
            ...
            logger.info(f"Retrieved operational summary for {len(result)} water heaters")
            return result
