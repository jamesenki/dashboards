...
class TestAlertConfigurationUI(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with open(
            "/Users/lisasimon/repos/IoTSphereAngular/IoTSphere-Refactor/frontend/templates/model-monitoring/dashboard.html",
            "r",
        ) as f:
    ...
    def test_load_alert_rules_functionality(self):
        ...
        self.assertIn(
            "document.getElementById('alert-rules-list').innerHTML", script_content
        )
