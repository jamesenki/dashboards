...
class TestComponentFailurePredictionComponent:
    ...
    def test_health_indicator_color(self, sample_prediction_data):
        ...
        high_prob_prediction = sample_prediction_data.copy(update={"predicted_value": 0.8})
        ...
        med_prob_prediction = sample_prediction_data.copy(update={"predicted_value": 0.5})
        ...
        low_prob_prediction = sample_prediction_data.copy(update={"predicted_value": 0.2})
