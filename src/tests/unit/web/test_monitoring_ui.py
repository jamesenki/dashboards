...
class TestMonitoringUI(unittest.TestCase):
    ...
    @patch(
        "src.monitoring.model_monitoring_service.ModelMonitoringService.get_monitored_models"
    )
    def test_enable_monitoring_ui_element(self, mock_get_all_models):
        ...
        self.assertIsNotNone(
            monitoring_status, "Monitoring status container should exist"
        )

        # It should have a style attribute containing 'display: none'
        self.assertIn(
            "display: none",
            monitoring_status.get("style", ""),
    ...
    @patch(
        "src.monitoring.model_monitoring_service.ModelMonitoringService.get_archived_models"
    )
