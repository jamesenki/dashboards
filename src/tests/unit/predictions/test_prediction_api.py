...
def app(mock_prediction_service):
    ...
    def list_prediction_types():
        ...
        return {
            "prediction_types": mock_prediction_service.model_registry.list_models()
        }
...
class TestPredictionAPI:
    ...
    def test_generate_prediction(self, test_client, mock_prediction_service):
        ...
        async def mock_generate(*args, **kwargs):
            return {
                ...
                "recommended_actions": [
                    {
                        "description": "Replace heating element within 30 days",
                        "severity": "medium",
                        "impact": "reliability",
                    }
                ],
    ...
    def test_generate_prediction_invalid_type(
        ...
        request_data = {
            ...
            "features": {"temperature": [65.0, 68.0, 70.0]},
        }
    ...
    def test_get_model_health(self, test_client, mock_prediction_service):
        ...
        mock_prediction_service.check_model_health.return_value = {
            ...
            "drift": {
                "feature_drift": {"temperature": 0.05, "pressure": 0.12},
