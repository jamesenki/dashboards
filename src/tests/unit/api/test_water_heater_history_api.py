...
class TestWaterHeaterHistoryAPI:
    ...
    @patch('src.services.water_heater_history.WaterHeaterHistoryService.get_history_dashboard')
    def test_get_history_dashboard(self, mock_get_history_dashboard, mock_get_water_heater):
    ...
    @patch('src.services.water_heater.WaterHeaterService.get_water_heater')
    @patch('src.services.water_heater_history.WaterHeaterHistoryService.get_temperature_history')
    def test_get_temperature_history(self, mock_get_temperature_history, mock_get_water_heater):
        ...
        # Act
        response = client.get(f"/api/water-heaters/{heater_id}/history/temperature?days={days}")
    ...
    @patch('src.services.water_heater.WaterHeaterService.get_water_heater')
    @patch('src.services.water_heater_history.WaterHeaterHistoryService.get_energy_usage_history')
    def test_get_energy_usage_history(self, mock_get_energy_usage_history, mock_get_water_heater):
        ...
        # Act
        response = client.get(f"/api/water-heaters/{heater_id}/history/energy?days={days}")
    ...
    @patch('src.services.water_heater.WaterHeaterService.get_water_heater')
    @patch('src.services.water_heater_history.WaterHeaterHistoryService.get_pressure_flow_history')
    def test_get_pressure_flow_history(self, mock_get_pressure_flow_history, mock_get_water_heater):
        ...
        # Act
        response = client.get(f"/api/water-heaters/{heater_id}/history/pressure-flow?days={days}")
