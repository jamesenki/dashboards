...
class TestDataAccessLayer:
    ...
    def setup_method(self):
        ...
        with patch('src.api.data_access.config', self.config_service), \
             patch('src.api.data_access.mock_data_provider', self.mock_provider):
    ...
    def test_get_devices_with_specific_type(self):
        ...
        self.mock_provider.is_mock_data_available.side_effect = lambda x: x == 'devices/water_heaters'
        ...
        # Verify the mock provider was called correctly
        self.mock_provider.is_mock_data_available.assert_called_with('devices/water_heaters')
