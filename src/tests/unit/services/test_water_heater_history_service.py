...
class TestWaterHeaterHistoryService:
    ...
    async def test_get_temperature_history(self):
        ...
        with patch('src.services.water_heater.WaterHeaterService.get_water_heater') as mock_get_heater:
    ...
    async def test_get_history_dashboard(self):
        ...
        with patch('src.services.water_heater_history.WaterHeaterHistoryService.get_temperature_history') as mock_temp, \
             patch('src.services.water_heater_history.WaterHeaterHistoryService.get_energy_usage_history') as mock_energy, \
             patch('src.services.water_heater_history.WaterHeaterHistoryService.get_pressure_flow_history') as mock_pressure:
