...
class TestWaterHeaterService:
    ...
    @pytest.mark.asyncio
    async def test_get_water_heaters(self, water_heater_service, mock_dummy_data, sample_water_heater):
    ...
    @pytest.mark.asyncio
    async def test_get_water_heater(self, water_heater_service, mock_dummy_data, sample_water_heater):
    ...
    @pytest.mark.asyncio
    async def test_get_water_heater_not_found(self, water_heater_service, mock_dummy_data):
    ...
    @pytest.mark.asyncio
    async def test_create_water_heater(self, water_heater_service, mock_dummy_data, sample_water_heater):
    ...
    @pytest.mark.asyncio
    async def test_update_target_temperature(self, water_heater_service, mock_dummy_data, sample_water_heater):
        """Test updating a water heater's target temperature."""
        # Setup mock behavior
        mock_dummy_data.get_water_heater.return_value = sample_water_heater
        updated_heater = sample_water_heater.model_copy(update={"target_temperature": 55.0})
        mock_dummy_data.update_water_heater.return_value = updated_heater
        
        # Call the service method
        updated = await water_heater_service.update_target_temperature("test-water-heater-1", 55.0)
    ...
    @pytest.mark.asyncio
    async def test_update_mode(self, water_heater_service, mock_dummy_data, sample_water_heater):
        """Test updating a water heater's operational mode."""
        # Setup mock behavior
        mock_dummy_data.get_water_heater.return_value = sample_water_heater
        updated_heater = sample_water_heater.model_copy(update={"mode": WaterHeaterMode.BOOST})
        mock_dummy_data.update_water_heater.return_value = updated_heater
        
        # Call the service method
        updated = await water_heater_service.update_mode("test-water-heater-1", WaterHeaterMode.BOOST)
    ...
    @pytest.mark.asyncio
    async def test_add_temperature_reading(self, water_heater_service, mock_dummy_data, sample_water_heater):
        """Test adding a temperature reading to a water heater."""
        # Setup mock behavior
        mock_dummy_data.get_water_heater.return_value = sample_water_heater
        
        updated_heater = sample_water_heater.model_copy(update={"current_temperature": 52.0})
        mock_dummy_data.update_water_heater.return_value = updated_heater
    ...
    @pytest.mark.asyncio
    async def test_update_heater_status_based_on_reading(self, water_heater_service, mock_dummy_data, sample_water_heater):
