...
class TestMonitoringDashboardAPI:
    ...
    def test_get_model_versions_endpoint(self, client, app):
        ...
        app.state.monitoring_service.get_model_versions.assert_called_once_with(
            self.model_id
        )
    ...
    def test_get_performance_summary_endpoint(self, client, app):
        ...
        # Arrange
        summary = {
            "latest_metrics": {"accuracy": 0.92, "precision": 0.88},
            "historical_average": {"accuracy": 0.90, "precision": 0.86},
            "trend": {"accuracy": "improving", "precision": "stable"},
        }
        app.state.monitoring_service.get_model_performance_summary.return_value = (
            summary
        )
    ...
    def test_calculate_drift_endpoint(self, client, app):
        ...
        drift_results = {"accuracy": -0.05, "precision": -0.03}
