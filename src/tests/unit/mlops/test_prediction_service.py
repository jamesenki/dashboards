...
class TestPredictionService:
    ...
    def test_predict(self, mock_joblib_load):
        ...
        mock_model.predict_proba.return_value = np.array([[0.85, 0.15]])  # 15% chance of failure
    ...
    def test_batch_predict(self, mock_joblib_load):
        ...
        model_name = "component_failure"
        mock_model = Mock()
        mock_model.predict.return_value = np.array([0, 1, 0])  # Second device predicted to fail
        ...
        batch_data = [
            {"device_id": "WH-1001", "temp": 65.5, "pressure": 32.1, "vibration": 0.03, "age_days": 720},
            {"device_id": "WH-1002", "temp": 78.3, "pressure": 34.5, "vibration": 0.07, "age_days": 980},
            {"device_id": "WH-1003", "temp": 68.2, "pressure": 33.0, "vibration": 0.04, "age_days": 540}
        ]
    ...
    def test_get_prediction_explanation(self, mock_joblib_load):
        ...
        assert explanation["top_features"][0]["feature"] == "age_days"  # Highest importance
    ...
    def test_predict_with_version(self):
        ...
        mock_model = Mock()
        mock_model.predict.return_value = np.array([0])  # Not failed
        mock_model.predict_proba.return_value = np.array([[0.9, 0.1]])  # 10% chance of failure
