...
class TestFeatureStore:
    ...
    def setup_method(self):
        ...
        # Sample mock data
        self.mock_raw_data = [
            {"device_id": "wh-123", "temperature": 142, "pressure": 55, "age_days": 732, "timestamp": datetime(2025, 1, 1)},
            {"device_id": "wh-123", "temperature": 145, "pressure": 57, "age_days": 733, "timestamp": datetime(2025, 1, 2)},
            {"device_id": "wh-456", "temperature": 138, "pressure": 50, "age_days": 365, "timestamp": datetime(2025, 1, 3)},
            {"device_id": "wh-456", "temperature": 139, "pressure": 51, "age_days": 366, "timestamp": datetime(2025, 1, 4)}
        ]
    ...
    def test_get_training_dataset_with_filtering(self):
        ...
        filtered_data = [rec for rec in self.mock_raw_data 
    ...
    def test_get_training_dataset_with_derived_features(self):
        ...
        assert len(result) == 4
        assert all(feature in result[0] for feature in feature_names)
        assert abs(result[0]["temperature_pressure_ratio"] - (result[0]["temperature"] / result[0]["pressure"])) < 0.001