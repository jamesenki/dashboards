    ...
    try:
        ...
        if "temperature" in data:
            ...
            if data["temperature"] and "average_temperature" in data["temperature"]:
                print(
                    f"average_temperature exists: {data['temperature']['average_temperature']}"
                )
            else:
                print(
                    "ERROR: average_temperature field is missing or temperature is null"
                )
                if data["temperature"] is None:
                    ...
                    print(
                        ...
                        json.dumps(data["temperature"], indent=2),
                    )
        else:
