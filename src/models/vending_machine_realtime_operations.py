...
class VendingMachineOperationsData(BaseModel):
    ...
    freezerTemperatureData: FreezerTemperatureData = Field(..., description="Freezer temperature gauge data")
    dispensePressureData: DispensePressureData = Field(..., description="Dispense pressure gauge data")
    ...
    # Inventory data
    freezerInventory: List[FlavorInventory] = Field(..., description="Freezer inventory data")
