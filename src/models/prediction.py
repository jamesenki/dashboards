...
class PredictionResult(BaseModel):
    ...
    prediction_time: datetime = Field(default_factory=datetime.now, description="Time when prediction was generated")
    ...
    factors: List[Dict[str, Any]] = Field(default_factory=list, description="Contributing factors to the prediction")
    recommended_actions: List[Dict[str, Any]] = Field(default_factory=list, description="Recommended actions based on prediction")
