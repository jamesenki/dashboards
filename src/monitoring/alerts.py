...
class NotificationService:
    ...
    def __init__(self, channels=None):
        ...
        self.channels = channels or {"email": True, "slack": False, "webhook": False}
    ...
    def send_alert(self, alert: AlertEvent) -> bool:
        ...
        print(
            f"ALERT: {alert.severity} alert for model {alert.model_id} {alert.model_version}"
        )
        print(
            f"Metric {alert.metric_name} is {alert.actual_value}, threshold: {alert.operator} {alert.threshold}"
        )
    ...
    def send_notification(
        self, title: str, message: str, severity: str = "MEDIUM", channels=None
    ) -> bool:
        """
    ...
    def _send_email(self, alert: AlertEvent) -> None:
        ...
        print(
            f"[EMAIL] Alert sent for model {alert.model_id}: {alert.metric_name} {alert.operator} {alert.threshold}"
        )
    ...
    def _send_slack(self, alert: AlertEvent) -> None:
        ...
        print(
            f"[SLACK] Alert sent for model {alert.model_id}: {alert.metric_name} {alert.operator} {alert.threshold}"
        )
    ...
    def _send_webhook(self, alert: AlertEvent) -> None:
        ...
        print(
            f"[WEBHOOK] Alert sent for model {alert.model_id}: {alert.metric_name} {alert.operator} {alert.threshold}"
        )
