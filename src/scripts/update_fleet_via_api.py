...
def prepare_vending_machine_for_api(index):
    ...
    device_status = (
        ...
        else DeviceStatus.OFFLINE.value
    )
            ...
            for machine in existing_machines:
                ...
                if vm_id:
                    ...
                    if delete_response.status_code == 204:
                        ...
                        print(
                            f"  Failed to delete machine {vm_id}: {delete_response.status_code}"
                        )
        else:
    ...
    for i in range(NUM_MACHINES):
        ...
        try:
            ...
            if response.status_code == 201:
                ...
                print(
                    f"  Created {machine['name']} ({machine['id']}) at {machine['location_business_name']}"
                )
                success_count += 1
            else:
