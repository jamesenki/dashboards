...
"""
import os
from typing import Dict, Any, Optional, Type, TypeVar, List, Tuple, Union
from pydantic import BaseModel, ValidationError

from src.config.exceptions import ConfigurationError, ConfigurationValidationError, ConfigurationAccessError
...
class ConfigurationService:
    ...
    def __init__(self, initial_config: Optional[Dict[str, Any]] = None):
        ...
        # Configuration cache
        self._config_cache: Optional[Dict[str, Any]] = initial_config.copy() if initial_config else None
    ...
    def get_section(self, section: str, default: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        raise ConfigurationAccessError(f"Configuration section is not a dictionary: {section}")
    ...
    def get_validated(self, section: str, model_class: Type[T]) -> T:
        ...
        try:
            ...
            raise ConfigurationValidationError(f"Configuration validation failed for {section}: {e}")
