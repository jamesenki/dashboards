...
def run_all_tests():
    ...
    success = success and run_test("tests/repositories/test_sqlite_water_heater_repository.py")
    ...
    if os.path.exists(integration_test_path):
        ...
        print(f"WARNING: {integration_test_path} not found. Skipping integration tests.")
    ...
    if success:
        ...
        print("The water heater configuration management implementation meets the requirements.")
    else:
