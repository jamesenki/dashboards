...
from src.repositories.water_heater_repository import MockWaterHeaterRepository, SQLiteWaterHeaterRepository
...
class TestWaterHeaterConfiguration(unittest.TestCase):
    ...
    def test_update_water_heater(self):
        ...
        updated = asyncio.run(self.service.update_mode(device_id, WaterHeaterMode.BOOST))
