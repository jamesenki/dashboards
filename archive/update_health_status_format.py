...
def main():
    ...
    try:
        ...
        for old_status, new_status in status_mapping.items():
            ...
            logger.info(
                f"Updated {cursor.rowcount} records in model_health from {old_status} to {new_status}"
            )
        ...
        for old_status, new_status in status_mapping.items():
            ...
            logger.info(
                f"Updated {cursor.rowcount} records in model_health_reference from {old_status} to {new_status}"
            )
