...
class TestMetadataEventsWebSocket:
    ...
    @pytest.mark.asyncio
    async def test_metadata_ws_subscription(
        self, mock_asset_service, mock_websocket, mock_request
    ):
        ...
        mock_asset_service.subscribe_to_metadata_changes.side_effect = (
        ...
        with patch(
            "src.api.metadata_events_ws.get_asset_service",
    ...
    @pytest.mark.asyncio
    async def test_metadata_ws_device_filter(
        self, mock_asset_service, mock_websocket, mock_request
    ):
        ...
        mock_websocket.receive.side_effect = [MagicMock(type="websocket.close")]
