...
def add_test_machine():
    ...
    try:
        ...
        response = requests.post(
            "http://localhost:8007/api/vending-machines", 
            json=test_machine
        )
        ...
        response = requests.post(
            f"http://localhost:8007/api/vending-machines/{vm_id}/readings",
            json=reading
        )
        response.raise_for_status()
        ...
        print(f"You can now access the operations summary at: http://localhost:8007/vending-machines/{vm_id}")
...
if __name__ == "__main__":
    ...
    if vm_id:
        ...
        print(f"2. Operations API: http://localhost:8007/api/vending-machines/{vm_id}/operations")
